                ...
                <div className="notif-card-body">
                  ...
                  <div className="notif-card-footer">
                    ...
                    <div className="notif-card-actions">
                      {viewMode === 'RECEPTION' && !notif.lue && (
                        <button onClick={e => { e.stopPropagation(); handleMarkRead(notif.id_notif); }} title="Marquer comme lu">
                          <FiCheckCircle />
                        </button>
                      )}
                      {viewMode === 'RECEPTION' && (
                        <button className="delete-btn" onClick={e => { e.stopPropagation(); handleDelete(notif.id_notif); }} title="Supprimer">
                          <FiTrash2 />
                        </button>
                      )}
                    </div>
