          ...
          <table style={{ width: '100%', minWidth: '1300px', borderCollapse: 'collapse' }}>
            <thead>
              <tr style={{ background: 'linear-gradient(to right,#f8fafc,#f1f5f9)', borderBottom: '2px solid #e2e8f0' }}>
                <th className="sticky-col-first" style={{ padding: '1rem 0.75rem', textAlign: 'left', fontSize: '0.9rem', fontWeight: '800', color: '#475569', textTransform: 'uppercase' }}>Utilisateur</th>
                <th style={{ padding: '1rem 0.75rem', textAlign: 'left', fontSize: '0.9rem', fontWeight: '800', color: '#475569', textTransform: 'uppercase' }}>Email</th>
                <th style={{ padding: '1rem 0.75rem', textAlign: 'left', fontSize: '0.9rem', fontWeight: '800', color: '#475569', textTransform: 'uppercase' }}>Rôle</th>
                <th style={{ padding: '1rem 0.75rem', textAlign: 'left', fontSize: '0.9rem', fontWeight: '800', color: '#475569', textTransform: 'uppercase' }}>Direction</th>
                <th style={{ padding: '1rem 0.75rem', textAlign: 'left', fontSize: '0.9rem', fontWeight: '800', color: '#475569', textTransform: 'uppercase' }}>Téléphone</th>
                <th style={{ padding: '1rem 0.75rem', textAlign: 'left', fontSize: '0.9rem', fontWeight: '800', color: '#475569', textTransform: 'uppercase' }}>Statut</th>
                <th style={{ padding: '1rem 0.75rem', textAlign: 'left', fontSize: '0.9rem', fontWeight: '800', color: '#475569', textTransform: 'uppercase' }}>Création</th>
                <th className="sticky-col-last" style={{ padding: '1rem 0.75rem', textAlign: 'center', fontSize: '0.9rem', fontWeight: '800', color: '#475569', textTransform: 'uppercase' }}>Actions</th>
              </tr>
            </thead>
            <tbody>
              {paginated.length === 0 ? (
                ...
                <tr key={u.id_user} className="user-row" onClick={() => setDetailUser(u)}
                  ...
                  <td style={{ padding: '1.25rem 1.5rem', fontSize: '0.9rem', color: '#94a3b8' }}>
