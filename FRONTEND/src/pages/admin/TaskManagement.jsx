                ...
                >
                  ...
                  <td className="sticky-col-first" style={{ position: 'sticky', left: 0, zIndex: 2, background: 'inherit', padding: '14px 16px', borderRight: '1px solid #f1f5f9', whiteSpace: 'nowrap' }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                      ...
                      <div>
                        <div style={{ fontSize: '0.875rem', fontWeight: 800, color: '#000000', letterSpacing: '0.01em' }}>{task.titre_tache}</div>
                        <div style={{ fontSize: '0.75rem', color: '#3b82f6', fontWeight: 600, marginTop: '2px' }}>{task.code_tache}</div>
                      </div>
                    </div>
                  </td>
