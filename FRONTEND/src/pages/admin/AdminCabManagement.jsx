            ...
            <thead>
              <tr style={{ background: '#f8fafc', borderBottom: '1px solid #e2e8f0' }}>
                ...
                <th className="sticky-col-first" style={{
                  ...
                  padding: '12px 16px', fontSize: '0.9rem', fontWeight: 800,
              ...
              {loading ? (
                ...
                >
                  ...
                  <td className="sticky-col-first" style={{
                    ...
                    <div style={{ fontWeight: 700, color: '#0f172a', fontSize: '0.95rem', marginBottom: '3px', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis', maxWidth: '220px' }}>
