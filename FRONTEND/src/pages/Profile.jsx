...
const Profile = () => {
  ...
  const [activeTab, setActiveTab] = useState('overview'); // 'overview' ou 'info'
  ...
  const handleProfileUpdate = async (e) => {
    ...
    setLoading(true);
    try {
      // Utilise l'endpoint PUT /users/:id car l'endpoint /users/profile n'existe pas dans le backend
      const response = await api.put(`/users/${user.id_user}`, profileData);
