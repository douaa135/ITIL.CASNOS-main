        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
          ...
          <Card style={{ background: '#f8fafc', border: '1px solid #cbd5e1' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '0.25rem' }}>
                <label style={{ fontSize: '0.85rem', color: '#475569', fontWeight: '500' }}>Environnement Cible <span style={{ color: '#ef4444' }}>*</span></label>
                <select 
                  value={selectedEnv}
              ...
              <Button 
                ...
                icon={<FiUsers />}
                disabled={currentStatus !== 'NOUVEAU' || !selectedEnv || !recommendation.trim()}
              >
                Convoquer le CAB
              </Button>
              ...
              <Button 
                ...
                icon={<FiCheckCircle />}
                disabled={currentStatus === 'APPROUVE' || !recommendation.trim() || !selectedEnv}
              >
