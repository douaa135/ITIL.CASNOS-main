...
import RfcHistoryManager      from './pages/changemanager/RfcHistory';
...
import CabMeetings        from './pages/changemanager/CabMeetings';
import CabMeetingsAdmin   from './pages/admin/CabMeetingsAdmin';
import CabMeetingsMember  from './pages/cab/CabMeetingsMember';
        ...
        <SocketProvider>
          <Router>
            ...
            <Route element={<ProtectedRoute><ChangeManagerLayout /></ProtectedRoute>}>
              ...
              <Route path="/manager/rfcs/history"       element={<RfcHistoryManager />} />
              ...
              <Route path="/manager/planning"           element={<Planning />} />
            ...
            <Route element={<ProtectedRoute><AdminLayout /></ProtectedRoute>}>
              ...
              <Route path="/admin/rfcs/history" element={<RfcHistoryManager />} />
              ...
              <Route path="/admin/cab/meetings" element={<CabMeetingsAdmin />} />
              ...
              <Route path="/admin/implementation" element={<ImplementationTracker />} />
            ...
            <Route element={<ProtectedRoute><ServiceDeskLayout /></ProtectedRoute>}>
              ...
              <Route path="/servicedesk/rfcs/new"  element={<RfcCreate />} />
            </Route>
            ...
            <Route element={<ProtectedRoute><CabLayout /></ProtectedRoute>}>
              ...
              <Route path="/cab/meetings"             element={<CabMeetingsMember />} />
            </Route>
