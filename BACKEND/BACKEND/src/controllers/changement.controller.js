...
// ============================================================
// À extraire dans un fichier séparé et monter dans app.js :
//   const chgExtrasRoutes = require('./routes/changement_extras.routes');
//   app.use('/api/changements', chgExtrasRoutes);
//
// PIR (1-to-1 Changement)
//   GET    /api/changements/:id/pir
//   POST   /api/changements/:id/pir
//   PUT    /api/changements/:id/pir
//   DELETE /api/changements/:id/pir
//
// TESTS (n-to-1 Changement)
//   GET    /api/changements/:id/tests
//   POST   /api/changements/:id/tests
//   PUT    /api/changements/:id/tests/:id_test
//   DELETE /api/changements/:id/tests/:id_test
// ============================================================