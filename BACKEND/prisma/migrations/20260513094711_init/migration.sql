...
-- CreateEnum
CREATE TYPE "TypeCab" AS ENUM ('NORMAL', 'URGENT');
...
-- CreateEnum
CREATE TYPE "TypeBlackout" AS ENUM ('JOUR_FERIE', 'PERIODE_CRITIQUE', 'MAINTENANCE', 'AUTRE');
...
CREATE TABLE "notification" (
    ...
    "objet" VARCHAR(200),
    "type_notif" "TypeNotification" NOT NULL DEFAULT 'IN_APP',
...
CREATE TABLE "user_notification" (
    ...
    CONSTRAINT "user_notification_pkey" PRIMARY KEY ("id_notif","id_user")
);
...
CREATE TABLE "blackout_period" (
    "id_blackout" UUID NOT NULL,
    "code_metier" VARCHAR(40) NOT NULL,
    "libelle" VARCHAR(200) NOT NULL,
    "type" "TypeBlackout" NOT NULL,
    ...
    CONSTRAINT "blackout_period_pkey" PRIMARY KEY ("id_blackout")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "blackout_period_code_metier_key" ON "blackout_period"("code_metier");
...
-- AddForeignKey
ALTER TABLE "notification" ADD CONSTRAINT "notification_id_expediteur_fkey" FOREIGN KEY ("id_expediteur") REFERENCES "utilisateur"("id_user") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "user_notification" ADD CONSTRAINT "user_notification_id_notif_fkey" FOREIGN KEY ("id_notif") REFERENCES "notification"("id_notif") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "user_notification" ADD CONSTRAINT "user_notification_id_user_fkey" FOREIGN KEY ("id_user") REFERENCES "utilisateur"("id_user") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "rapport" ADD CONSTRAINT "rapport_id_rfc_fkey" FOREIGN KEY ("id_rfc") REFERENCES "rfc"("id_rfc") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "rapport" ADD CONSTRAINT "rapport_id_changement_fkey" FOREIGN KEY ("id_changement") REFERENCES "changement"("id_changement") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "blackout_period" ADD CONSTRAINT "blackout_period_id_user_fkey" FOREIGN KEY ("id_user") REFERENCES "utilisateur"("id_user") ON DELETE SET NULL ON UPDATE CASCADE;
