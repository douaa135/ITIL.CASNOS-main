...
async function main() {
  ...
  for (const n of notificationsRaw) {
    const id_user       = ids.users[n.destinataireEmail];
    ...
    await prisma.notification.upsert({
      ...
      update: { message: n.message, lue: n.lue },
      create: { code_metier: n.code_metier, message: n.message, objet: n.objet, type_notif: n.type_notif, lue: n.lue, id_user, id_rfc, id_changement },
    });
  }
  console.log(`   ✅ ${notificationsRaw.length} notifications`);
