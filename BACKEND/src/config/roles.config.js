...
const PERMISSIONS = {
  ...
  // ── PLANNING & BLACKOUT ────────────────────────────────────
  PLANNING_READ:      { code: 'planning:read',      description: 'Voir le calendrier et les blackouts',        module: 'PLANNING' },
  PLANNING_MANAGE:    { code: 'planning:manage',    description: 'Créer / modifier / supprimer des blackouts', module: 'PLANNING' },
  // ADMIN
...
const ROLE_PERMISSIONS = {
  ...
  [ROLES.CHANGE_MANAGER]: [
    ...
    PERMISSIONS.PLANNING_READ.code,
  ],
