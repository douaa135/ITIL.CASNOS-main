...
const validateEvaluationRisque = (req, res, next) => {
  const impacte = req.body.impacte !== undefined ? req.body.impacte : req.body._impacte;
  const probabilite = req.body.probabilite !== undefined ? req.body.probabilite : req.body._probabilite;
