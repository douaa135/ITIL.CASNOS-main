...
function _resoudreIdUser(req, queryUser = null) {
  // Dans un outil ITIL, le FSC (planning des changements) est partagé et visible par tous.
  // On permet à tout le monde de voir l'ensemble des changements par défaut.
